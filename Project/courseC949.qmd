...
::: {.callout-note title="Common Big Os" collapse="true" appearance="simple" icon="false" style="border-left:none; border-right:none; border-top:none; border-bottom:none;"}
  ...
  2. **`$\text{O(log n)}$ - Logarithmic Time`:**
  ...
  4. **`$\text{O(n log n)}$ - Log-Linear Time`:**
...
To determine where the data associated with the last 4 digits of the Social 
Security number ('2023') will be stored in the array, follow these steps:
