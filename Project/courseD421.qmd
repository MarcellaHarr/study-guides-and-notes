...
[**Set operations**]{.mark .vocab} are mathematical procedures used to create 
...
A [**set expression**]{.mark .vocab} is a mathematical statement that combines 
...
A [**defined set**]{.mark .vocab} is when its elements are explicitly or 
...
the set $A_i$ contains all [**integer multiples**]{.mark .vocab} of $i$.
...
::: {.lead .text-center}
$A_1 = \{ \ldots, -3, -2, -1, 0, 1, 2, 3, \ldots \}$
:::

  - $A_2$ is the set of all even integers

::: {.lead .text-center}
$A_2 = \{ \ldots, -4, -2, 0, 2, 4, \ldots \}$
:::

  - $A_3$ is the set of all integers divisible by 3

::: {.lead .text-center}
$A_3 = \{ \ldots, -6, -3, 0, 3, 6, \ldots \}$
:::

  - $A_4$ is the s- et of all integers divisible by 4

::: {.lead .text-center}
$A_4 = \{ \ldots, -8, -4, 0, 4, 8, \ldots \}$
:::

  - $A_5$ is the set of all integers divisible by 5

::: {.lead .text-center}
$A_5 = \{ \ldots, -10, -5, 0, 5, 10, \ldots \}$
:::
