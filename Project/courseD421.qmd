...
```{r install-table-packages, include=FALSE}
...
if (!requireNamespace("kableExtra", quietly = TRUE)) {
  install.packages("kableExtra", repos = repos)
}
library(knitr)
library(magrittr)
library(kableExtra)
...
tab <- kbl(
  ...
  caption = "Summary Set Identity Laws"
)
