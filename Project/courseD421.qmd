...
| Name/Law               | Identity A                      | Identity B                      | Description                                               |
|------------------------|----------------------------------|----------------------------------|-----------------------------------------------------------|
| Identity Laws  | $(\, \mathbb{A} \cap \mathbb{U} = \mathbb{A} )\,$  | $(\, \mathbb{A} \cup \emptyset = \mathbb{A} )\,$  | Union or intersection with identity elements keeps $(\, \mathbb{A} )\,$ |
| Domination Laws | $(\, \mathbb{A} \cup \mathbb{U} = \mathbb{U} )\,$  | $(\, \mathbb{A} \cap \emptyset = \emptyset )\,$ | Union with universal set and intersection with empty set |
| Idempotent Laws | $(\, \mathbb{A} \cup \mathbb{A} = \mathbb{A} )\,$  | $(\, \mathbb{A} \cap \mathbb{A} = \mathbb{A} )\,$ | Repeating the same set yields no change  |
| Complementation Law | $(\, (\mathbb{A}^`)^` = \mathbb{A} )\,$ | —  | Double complement returns the original set |
| Commutative Laws | $(\, \mathbb{A} \cup \mathbb{B} = \mathbb{B} \cup \mathbb{A} )\,$  | $(\, \mathbb{A} \cap \mathbb{B} = \mathbb{B} \cap \mathbb{A} )\,$  | Reordering operands doesn’t affect result |
| Associative Laws | $(\, \mathbb{A} \cup (\mathbb{B} \cup \mathbb{C}) = (\mathbb{A} \cup \mathbb{B}) \cup \mathbb{C} )\,$ | $(\, \mathbb{A} \cap (\mathbb{B} \cap \mathbb{C}) = (\mathbb{A} \cap \mathbb{B}) \cap \mathbb{C} )\,$ | Parentheses can be regrouped |
| Distributive Laws | $(\, \mathbb{A} \cup (\mathbb{B} \cap \mathbb{C}) = (\mathbb{A} \cup \mathbb{B}) \cap (\mathbb{A} \cup \mathbb{C}) )\,$ | $(\, \mathbb{A} \cap (\mathbb{B} \cup \mathbb{C}) = (\mathbb{A} \cap \mathbb{B}) \cup (\mathbb{A} \cap \mathbb{C}) )\,$ | Similar to algebraic distributive properties |
| De Morgan’s Laws | $(\, (\mathbb{A} \cup \mathbb{B})^` = \mathbb{A}^` \cap \mathbb{B}^` )\,$ | $(\, (\mathbb{A} \cap \mathbb{B})^` = \mathbb{A}^` \cup \mathbb{B}^` )\,$ | Switching union/intersection under complement |
| Absorption Laws | $(\, \mathbb{A} \cup (\mathbb{A} \cap \mathbb{B}) = \mathbb{A} )\,$ | $(\, \mathbb{A} \cap (\mathbb{A} \cup \mathbb{B}) = \mathbb{A} )\,$ | Combining $(\, \mathbb{A} )\,$ with a subset of itself yields $(\, \mathbb{A} )\,$ |
| Complement Laws  | $(\, \mathbb{A} \cup \mathbb{A}^` = \mathbb{U} )\,$  | $(\, \mathbb{A} \cap \mathbb{A}^` = \emptyset )\,$  | Elements must be in either $(\, \mathbb{A} )\,$ or its complement |

: Summary Set Identity Laws {#tbl-first .striped .hover}
