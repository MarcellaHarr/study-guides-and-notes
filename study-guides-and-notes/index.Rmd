...
bs_global_theme(bs_theme(
  ...
  bootswatch = "lux",
  primary = "#b38962",
  code_font = font_google("Fira Code", collection = FALSE),
  heading_font = font_google("IBM Plex Sans", collection = FALSE),
  base_font = font_google("Open Sans", collection = FALSE)
))
```
